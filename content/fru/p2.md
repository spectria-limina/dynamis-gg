...
<button type="button" data-bs-toggle="collapse" data-bs-target="#collapse-me" onclick="collapseList[0].hide() ">Collapse</button>

<div id="collapse-me" class="collapse">foo</div>
